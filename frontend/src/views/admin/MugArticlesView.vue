...
<template>
  <section class="space-y-4">
    <AdminPageHeader title="Mugs" breakpoint="lg">
      <template #actions>
    ...
    <Alert v-if="articlesStore.error" variant="destructive">Failed to load mugs.</Alert>
    ...
    >
      <p>No mugs match the active filters.</p>
    ...
    <AdminArticlesTable
      v-else
      article-type="MUG"
      edit-route-name="admin-mug-article-edit"
