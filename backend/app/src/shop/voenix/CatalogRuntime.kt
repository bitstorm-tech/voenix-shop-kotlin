 ...
 * four capabilities here are the whole of what the rest of the application sees of it: [articles]
 * and [prompts] are what a cart line and an order line are priced from, [promotionCodes] is the
 * coupon lifecycle the cart and the checkout share, and [shippableCountries] is the list of
 * destinations a checkout's shipping address must name (issue #81).
 */
