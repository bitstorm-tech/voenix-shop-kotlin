...
internal class SupplierModule(
    ...
    fun install(application: Application): Unit = SupplierRoutes.install(application, operations)
}
...
internal fun Application.installSupplierModule(suppliers: SupplierOperations) =
