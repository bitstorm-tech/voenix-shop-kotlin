 ...
 * proves that a list of many prompts resolves its prices in a single batched lookup — and no entry
 * at all is what proves that an empty page asks the pricing module nothing.
 */
